...
def main():
    ...
    require("this public url serves the fixed static sample only; the interactive control room remains local-only and is not deployed." in html, "preview must disclose the public static/local interactive separation")
